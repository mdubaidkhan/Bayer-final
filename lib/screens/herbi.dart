...
Center(child: Column(children: [
  Column(children: [Container(
                    ...
                    Column(children: [
                      Text('New Roundup PowerMAX® 3 Herbicide',style: TextStyle(color: Colors.green[800],fontSize: 13.0),),
  ...
  Column(children: [Container(
                    ...
                    Column(children: [
                      Text('Roundup PowerMAX® Herbicide',style: TextStyle(color: Colors.green[800],fontSize: 13.0),),
                    ...
                    Column(children: [
                      Text('Harness® Xtra Herbicide for Corn',style: TextStyle(color: Colors.green[800],fontSize: 13.0),),
                      Text('More powerful grass and broadleaf weed control.'),
...
Column(children: [Container(
                    ...
                    Column(children: [
                      Text('DiFlexx® DUO Herbicide for Corn',style: TextStyle(color: Colors.green[800],fontSize: 13.0),),
                      Text('Give weeds the pounding they deserve next season.'),
